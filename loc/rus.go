...
func (e *rusloc) StartupMessage() string {
	return `🎅 Хо-хо-хо! Внимание, студенты! Мои эльфы уже дарят подарки на первом этаже университета.

Не забудьте поделиться радостью и праздничным настроением со своими однокурсниками. Давайте сделаем этот период года незабываемым!
	
Счастливого Рождества всем и хороших каникул в учебе! 🎁🎄`
}
