...
func (e *rusloc) StartupMessage() string {
	return `Привет, мой друг! Вот-вот случится чудо, и подарочки будут в руках получателей! Кстати, не забудь подписать и принести свой подарок в 319. И пусть случится волшебство!`
}
